...
for train_index, test_index in skf.split(X, y):
       ...
       pickle.dump(x_train,open('./Norm/xtrain.txt','wb'))
       pickle.dump(y_train,open('./Norm/ytrain.txt','wb'))
       pickle.dump(x_test,open('./Norm/xtest.txt','wb'))
       pickle.dump(y_test,open('./Norm/ytest.txt','wb'))
       print("="*30)
       aae_model('./feature_extraction/AAE/'+aaenum+'/',
       ...
       for layer in aae_prev_model.layers[1:]:
       ...
       for layer in aae_prev_model.layers:
           ...
           trainable=('dense_3' in layer.name)
