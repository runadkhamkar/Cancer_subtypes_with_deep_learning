...
for train_index, test_index in skf.split(X, y):
       ...
       path='./WithFineTunning/ucec/encoder'+aaenum+'.h5'
       model=getFeatures(path=path,X_train=x_train,y_train=y_train,X_test=x_test,y_test=y_test)
       model.save(path)
       path1='./WithFineTunning/ucec/encoder'+aaenum+'_tunned.h5'
...
result_final.to_csv("./results/12.5.21/result_withFinetunning.tsv", sep='\t')
print (result_final)
